    ...
    >
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px", display: "flex", alignItems: "center", justifyContent: "space-between", height: 64 }}>
        <button onClick={() => scrollTo("hero")} style={{ background: "none", border: "none", cursor: "pointer", display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <span style={{ fontFamily: "var(--font-display)", fontSize: 14, color: "var(--text-secondary)", fontWeight: 500, letterSpacing: "0.08em", textTransform: "uppercase" }}>Leon</span>
        </button>
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", width: "100%", position: "relative", zIndex: 1 }}>
        ...
        <Reveal delay={0.5}>
          <p style={{
            ...
            MSc. Computer Science Engineer expert at architecting enterprise learning programs that accelerate technical readiness across global software development teams. Hands-on with Copilot, Glean, ChatGPT, and Claude.
          </p>
        </Reveal>
        ...
        <Reveal delay={0.8}>
          <div style={{
            ...
            {[
              { n: 2100, s: "+", label: "Students Trained" },
              { n: 900, s: "", label: "Person Workforce" },
              { n: 4, s: "", label: "AI Programs Founded" },
              { n: 17, s: "+", label: "Years Teaching" },
            ].map((s, i) => (
              <div key={i}>
          ...
          <div>
            <Reveal delay={0.1}>
              <h2 style={{ fontFamily: "var(--font-display)", fontSize: "clamp(32px, 4vw, 48px)", fontWeight: 700, lineHeight: 1.15, letterSpacing: "-0.02em", color: "var(--text-primary)", margin: "0 0 28px" }}>
                ...
                <span style={{ color: "var(--accent)" }}>ship smarter, faster.</span>
              </h2>
            </Reveal>
            <Reveal delay={0.2}>
              <p style={{ fontFamily: "var(--font-body)", fontSize: 17, lineHeight: 1.75, color: "var(--text-secondary)", marginBottom: 20 }}>
                I lead the design and delivery of onboarding, credentialing, and AI adoption initiatives at Verndale, building scalable enablement programs that align engineering capabilities with strategic business goals across a nearly 900-person global workforce. I manage the AI enablement stack — Glean, ChatGPT, Claude, and Microsoft Copilot — building agents and workflow automations that expand L&D capacity.
              </p>
            </Reveal>
            <Reveal delay={0.3}>
              <p style={{ fontFamily: "var(--font-body)", fontSize: 17, lineHeight: 1.75, color: "var(--text-secondary)", marginBottom: 20 }}>
                Skilled at integrating training and knowledge management across merged and acquired companies. Strong negotiation skills with stakeholders and technology platform partners, with a recognized network across the Latin American and U.S. software development value chain. I also teach Web Engineering at UDLA, where I've designed competency-based curriculum for over 2,100 students.
              </p>
            </Reveal>
            <Reveal delay={0.4}>
...
function Work() {
  ...
  const projects = [
    {
      id: 1, span: "wide",
      tag: "AI ENABLEMENT", title: "AI Adoption Programs & Agent Building",
      desc: "Managed the AI enablement stack including Glean, ChatGPT, Claude, and Microsoft Copilot. Founded and led four internal AI adoption programs focused on practical GenAI use cases, project-based learning, creative applications, and responsible adoption. Built several AI agents and workflow automations that expanded L&D capacity and improved onboarding operations.",
      metrics: [{ v: "4", l: "AI Programs Founded" }, { v: "4+", l: "AI Platforms" }, { v: "Agents", l: "Built & Deployed" }],
      color: "#a855f7",
      icon: <Code size={24} />,
    },
    {
      ...
      desc: "Built Verndale's early-career, onboarding, and technical enablement architecture from the ground up — scaling role-based learning tracks, competency frameworks, and milestone checkpoints with structured pre-boarding, ramp plans, and 30/60/90-day follow-ups across a ~900-person workforce.",
      metrics: [{ v: "~900", l: "Person Workforce" }, { v: "30/60/90", l: "Day Milestones" }],
      color: "var(--accent)",
      icon: <Users size={24} />,
    },
    {
      id: 3, span: "normal",
      tag: "CREDENTIALING", title: "Partner Certification Programs",
      ...
      metrics: [{ v: "5", l: "Top-Tier Partners" }, { v: "Global", l: "Delivery Teams" }],
    ...
    },
    {
      ...
      desc: "Led L&D integration across multiple acquisitions, using capability gap analysis, LMS-based learning paths, and credentialing frameworks to accelerate workforce readiness and operational continuity. Built program infrastructure from the ground up in each case.",
      metrics: [{ v: "Multiple", l: "Acquisitions" }, { v: "Gap Analysis", l: "Led" }, { v: "LMS", l: "Learning Paths" }],
      color: "#f97316",
      icon: <Layers size={24} />,
    },
    {
      id: 5, span: "normal",
      tag: "ACADEMIA", title: "Web Engineering Curriculum (UDLA)",
      desc: "Designed and delivered competency-based curriculum and learning experiences for over 2,100 students, grounding courses in adult learning principles. Developed scenario-based assessments including coding challenges, cloud configuration, and architectural decision-making.",
      metrics: [{ v: "2,100+", l: "Students" }, { v: "17+", l: "Years Teaching" }],
      color: "#22c55e",
      icon: <BookOpen size={24} />,
    },
    {
      id: 6, span: "normal",
      tag: "KNOWLEDGE MGMT", title: "Enablement Content & User Guides",
      desc: "Produced user guides, FAQs, and training materials to support ongoing enablement and knowledge management. Built workflow automations with Power Automate, Glean agents, Claude Cowork agents, and ChatGPT agents integrated with Email, Slack, and Teams.",
      metrics: [{ v: "Multi-Channel", l: "Integrations" }, { v: "Scalable", l: "Delivery" }],
      color: "#06b6d4",
      icon: <Target size={24} />,
    },
  ];
...
function Expertise() {
  const skills = [
    { category: "AI & GenAI Tools", items: ["Claude (Certified)", "Claude Code", "Claude Cowork", "ChatGPT (Agent Builder)", "Glean (Agent Builder)", "Synthesia", "Notebook LM", "Gamma", "NapkinAI", "Sora", "Microsoft Copilot"] },
    { category: "LMS & Learning Tech", items: ["Moodle", "Rippling LMS", "Udemy", "Jira/Confluence Tracking", "Adoption & Completion Reporting", "Business Impact Reporting"] },
    { category: "Workflow Automation", items: ["Power Automate", "Glean Agents", "Claude Cowork Agents", "ChatGPT Agents", "Email Integrations", "Slack & Teams Integrations"] },
    { category: "Instructional Design", items: ["Adult Learning Principles", "Onboarding Program Design", "Performance-Based Assessment", "Content Lifecycle Mgmt", "Rapid Prototyping"] },
    { category: "Content & Design", items: ["Short-Form Video", "After Effects", "Premiere", "Audition", "Figma", "Photoshop", "Vercel"] },
    { category: "Project & Stakeholder Mgmt", items: ["Jira", "Confluence", "Trello", "Scrum", "Kanban", "Cross-Functional Coordination", "Timeline Management"] },
  ];
      ...
      <div style={{
        ...
        <article style={{ padding: "60px 32px 80px", maxWidth: 680, margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12, paddingBottom: 32, marginBottom: 40, borderBottom: "1px solid var(--border)" }}>
            ...
            <div>
              <div style={{ fontFamily: "var(--font-body)", fontSize: 14, fontWeight: 600, color: "var(--text-primary)" }}>Juan Jose Leon</div>
              <div style={{ fontFamily: "var(--font-mono)", fontSize: 12, color: "var(--text-tertiary)" }}>Senior Technical Trainer & L&D Program Lead · Verndale</div>
            </div>
          </div>
      ...
      <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center" }}>
        ...
        <Reveal delay={0.2}>
          <p style={{ fontFamily: "var(--font-body)", fontSize: 18, lineHeight: 1.7, color: "var(--text-secondary)", maxWidth: 500, margin: "0 auto 48px" }}>
            Currently exploring roles in Enterprise L&D, AI Enablement, User Onboarding, and Knowledge Management at global technology organizations.
          </p>
        </Reveal>
        <Reveal delay={0.3}>
