...
import { Mail, Linkedin, Github, ChevronDown, ExternalLink, ArrowRight, BookOpen, Users, Award, Briefcase, GraduationCap, Code, Layers, Target, TrendingUp, MapPin, Download, Menu, X, Sun, Moon } from "lucide-react";
    ...
    >
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 24px", display: "flex", alignItems: "center", justifyContent: "space-between", height: 64 }}>
        <button onClick={() => scrollTo("hero")} style={{ background: "none", border: "none", cursor: "pointer", display: "flex", alignItems: "center", gap: 8 }}>
          ...
          <span style={{ fontFamily: "var(--font-display)", fontSize: 14, color: "var(--text-secondary)", fontWeight: 500, letterSpacing: "0.08em", textTransform: "uppercase" }}>León</span>
        </button>
          ...
          <div style={{
            ...
            {links.map((l) => (
              <button key={l.id} onClick={() => scrollTo(l.id)} style={{
                ...
                onMouseLeave={(e) => { e.currentTarget.style.color = activeSection === l.id ? "var(--accent)" : "#ffffff"; e.currentTarget.style.transform = "none"; }}
              >
                {l.label}
              </button>
            ))}
...
function Hero() {
  ...
  const roles = ["Enterprise L&D & AI Enablement Lead", "AI Adoption Strategist", "User Onboarding Architect", "Knowledge Management Leader"];
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", width: "100%", position: "relative", zIndex: 1 }}>
        ...
        <Reveal delay={0.5}>
          <p style={{
            ...
            MSc. Computer Science Engineer architecting enterprise learning programs that accelerate technical readiness across global teams. Expert at AI adoption, onboarding design, and knowledge management at scale.
          </p>
        </Reveal>
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "start" }} className="about-grid">
          <div>
            <Reveal delay={0.1}>
              <h2 style={{ fontFamily: "var(--font-display)", fontSize: "clamp(32px, 4vw, 48px)", fontWeight: 700, lineHeight: 1.15, letterSpacing: "-0.02em", color: "var(--text-primary)", margin: "0 0 28px" }}>
                ...
                <span style={{ color: "var(--accent)" }}>and business outcomes.</span>
              </h2>
            </Reveal>
            <Reveal delay={0.2}>
              <p style={{ fontFamily: "var(--font-body)", fontSize: 17, lineHeight: 1.75, color: "var(--text-secondary)", marginBottom: 20 }}>
                I'm an MSc. Computer Science Engineer expert at architecting enterprise learning programs that accelerate technical readiness across global software development teams. At Verndale, I lead the design and delivery of onboarding, credentialing, and AI adoption initiatives for a nearly 900-person global workforce.
              </p>
            </Reveal>
            <Reveal delay={0.3}>
              <p style={{ fontFamily: "var(--font-body)", fontSize: 17, lineHeight: 1.75, color: "var(--text-secondary)", marginBottom: 20 }}>
                I've managed Glean, ChatGPT, Claude, and Microsoft Copilot to build AI agents and automations that expanded L&D capacity and supported scalable training delivery. As a full professor at UDLA, I've designed competency-based curriculum for 2,100+ students. Strong negotiator with platform partners and recognized across the Latin American and U.S. software development value chain.
              </p>
            </Reveal>
            <Reveal delay={0.4}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            {[
              { icon: <Briefcase size={20} />, title: "Verndale", sub: "Senior Technical Trainer & L&D Program Lead", period: "Sep 2016 – Present", accent: true },
              { icon: <GraduationCap size={20} />, title: "UDLA", sub: "Professor of Web Engineering", period: "2008 – Present" },
              { icon: <Code size={20} />, title: "Oshyn Inc", sub: "Front End Developer", period: "2008 – 2010" },
              ...
              { icon: <Layers size={20} />, title: "Mindsoft", sub: "Co-founder", period: "2003 – 2016" },
            ].map((item, i) => (
...
function Work() {
  ...
  const projects = [
    {
      id: 1, span: "wide",
      tag: "AI ENABLEMENT", title: "Enterprise AI Adoption Programs",
      ...
      metrics: [{ v: "4", l: "AI Programs" }, { v: "~900", l: "Team Members" }, { v: "Glean, Copilot, Claude", l: "AI Stack" }],
      color: "var(--accent)",
      icon: <Award size={24} />,
    },
    {
      id: 2, span: "normal",
      tag: "ONBOARDING", title: "Global Onboarding Architecture",
      ...
      metrics: [{ v: "30/60/90", l: "Day Model" }, { v: "4", l: "Regions" }],
      color: "var(--accent-secondary)",
      icon: <Users size={24} />,
    },
    {
      id: 3, span: "normal",
      tag: "CREDENTIALING", title: "Certification & Partnership Readiness",
      ...
      metrics: [{ v: "5", l: "Partner Tiers" }, { v: "Tiered", l: "Certs" }],
      color: "#22c55e",
      icon: <Target size={24} />,
    },
    {
      id: 4, span: "wide",
      tag: "M&A INTEGRATION", title: "Acquisition L&D Integration",
      ...
      metrics: [{ v: "0→1", l: "Program Build" }, { v: "Role-to-Skill", l: "Mapping" }, { v: "Multiple", l: "Acquisitions" }],
      color: "#f97316",
      icon: <Layers size={24} />,
    },
    {
      id: 5, span: "normal",
      tag: "KNOWLEDGE MGMT", title: "Learning Technology Stack",
      ...
      metrics: [{ v: "6+", l: "AI Tools" }, { v: "Agents & Automation", l: "Enabled" }],
      color: "#a855f7",
      icon: <Code size={24} />,
    },
    {
      id: 6, span: "normal",
      tag: "ACADEMICS", title: "UDLA Web Engineering Curriculum",
      ...
      metrics: [{ v: "2,100+", l: "Students" }, { v: "Competency-Based", l: "Design" }],
      color: "#06b6d4",
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        ...
        <Reveal delay={0.1}>
          <h2 style={{ fontFamily: "var(--font-display)", fontSize: "clamp(32px, 4vw, 48px)", fontWeight: 700, lineHeight: 1.15, letterSpacing: "-0.02em", color: "var(--text-primary)", margin: "0 0 60px" }}>
            Enterprise learning<br />at scale.
          </h2>
        </Reveal>
...
function Expertise() {
  const skills = [
    { category: "AI & GenAI Tools", items: ["Claude (Certified)", "ChatGPT (Agent Builder)", "Glean (Agent Builder)", "Microsoft Copilot", "Synthesia", "Notebook LM", "Gamma", "Claude Code", "Claude Cowork"] },
    { category: "LMS & Learning Tech", items: ["Moodle", "Rippling LMS", "Udemy", "Jira/Confluence", "Adoption Tracking", "Business Impact Reporting"] },
    { category: "Workflow Automation", items: ["Microsoft Power Automate", "Glean Agents", "Claude Agents", "ChatGPT Agents", "Email/Slack/Teams Integrations"] },
    { category: "Partner Platforms", items: ["Sitecore", "Optimizely", "Shopify", "Webflow", "Vercel", "Salesforce"] },
    { category: "Content & Design", items: ["Short-form Video", "Adobe After Effects", "Adobe Premiere", "Adobe Audition", "Figma", "Photoshop", "Vercel"] },
    { category: "Instructional Design", items: ["Adult Learning Principles", "Onboarding Design", "Performance-Based Assessment", "Content Lifecycle Management", "Rapid Prototyping", "Scrum", "Kanban"] },
  ];
  ...
  return (
    <section id="expertise" style={{ padding: "120px 24px", background: "var(--bg-secondary)" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        ...
        <Reveal delay={0.1}>
          <h2 style={{ fontFamily: "var(--font-display)", fontSize: "clamp(32px, 4vw, 48px)", fontWeight: 700, lineHeight: 1.15, letterSpacing: "-0.02em", color: "var(--text-primary)", margin: "0 0 60px" }}>
            Where learning meets<br />technology.
          </h2>
        </Reveal>
                ...
                <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
                  {group.items.map((item, ii) => (
                    <span key={ii} style={{
                      ...
                      onMouseEnter={(e) => { e.currentTarget.style.color = "var(--accent)"; e.currentTarget.style.background = "var(--tag-hover)"; }}
                      onMouseLeave={(e) => { e.currentTarget.style.color = "var(--text-secondary)"; e.currentTarget.style.background = "var(--tag-bg)"; }}
                    >
                      {item}
                    </span>
                  ))}
        ...
        <article style={{ padding: "60px 32px 80px", maxWidth: 680, margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12, paddingBottom: 32, marginBottom: 40, borderBottom: "1px solid var(--border)" }}>
            ...
            <div>
              ...
              <div style={{ fontFamily: "var(--font-mono)", fontSize: 12, color: "var(--text-tertiary)" }}>Enterprise L&D Lead · Verndale</div>
            </div>
          </div>
...
function Blog() {
  ...
  const posts = [
    {
      title: "Enterprise AI Adoption: From Proof of Concept to Organizational Culture",
      tag: "AI ADOPTION", date: "Mar 2026", read: "9 min", color: "var(--accent)",
      body: [
        { type: "p", text: "The difference between organizations that successfully embed AI into their operations and those that treat it as a one-off experiment comes down to one thing: culture. I've led four separate AI adoption programs at Verndale, and the key insight isn't about the tools — it's about how you structure the learning around them." },
        { type: "h2", text: "Start with Use Cases, Not Tools" },
        { type: "p", text: "The instinct is to say 'we're using Claude now, here's a training session.' Resist it. Begin by identifying the actual problems your teams face day-to-day. For an L&D team, it might be accelerating course outline generation. For engineering, it might be faster code review feedback. For design, faster mockup iteration. The tool serves the use case, not the other way around." },
        { type: "quote", text: "AI adoption fails when you push the tool. It succeeds when you solve the problem and the tool becomes the obvious solution." },
        { type: "h2", text: "Project-Based Learning Works Better Than Abstract Workshops" },
        ...
        { type: "p", text: "I produced user guides and FAQs that embedded responsible AI usage into the everyday workflow. Not as a compliance box to check, but as practical guidance: when does relying on AI output create risk? Where do you need human review? How do you spot hallucinations? These conversations happen naturally when you're working on actual projects." },
        { type: "h2", text: "What Success Looks Like" },
        { type: "p", text: "When the organization matures past the adoption phase, AI becomes invisible — not because people stop using it, but because it's integrated into how work gets done. You don't hear 'I used Claude to write this' anymore. You hear 'this document took half the time because we had better starting material to work from.' That's when you know the adoption succeeded." },
      ],
    },
    {
      title: "Building Onboarding Programs That Actually Predict Job Success",
      tag: "ONBOARDING", date: "Feb 2026", read: "8 min", color: "var(--accent-secondary)",
      body: [
        { type: "p", text: "Most onboarding programs are designed backward — they start with the question 'what does the company want to teach' instead of 'what does the new hire need to be productive?' I've built global onboarding infrastructure for a 900-person workforce, and the architecture that works is one that aligns with how adults actually learn." },
        { type: "h2", text: "The 30/60/90 Framework" },
        { type: "p", text: "I structure every onboarding journey with explicit milestones. By day 30, a new hire should understand the company culture, tools, and communication norms. By day 60, they should be actively contributing to projects at expected quality levels. By day 90, they should be independent — no longer needing check-ins about how to do their job. Each milestone has defined readiness criteria, not vague aspirations." },
        { type: "h2", text: "Pre-Boarding Is Where Outcomes Compound" },
        { type: "p", text: "The week before someone's first day is the highest-ROI time to invest. We send prep materials, set up their development environment, introduce them to key stakeholders asynchronously, and give them reading so they arrive on day one with context, not blank-slate confusion. This costs almost nothing to do right and eliminates the first-week ramp time that normally just wastes everyone's time." },
        { type: "quote", text: "A new hire who arrives prepared and oriented gets productive 2-3 weeks faster than one who shows up and starts from scratch." },
        { type: "h2", text: "Role-Specific Learning Paths Matter" },
        { type: "p", text: "An engineer's first 90 days are not the same as a project manager's. We built role-specific ramp plans that account for technical onboarding, team integration, project handoff, and cultural alignment. The shared foundation is consistent, but the path diverges based on what that role actually needs to do." },
        { type: "h2", text: "Measure What Matters" },
        { type: "p", text: "I track new-hire readiness using concrete metrics: time-to-first-project-contribution, quality of work at 60 days, manager confidence in independence at 90 days, and retention at the 6-month and 1-year marks. These aren't vanity metrics — they predict whether the onboarding actually worked." },
      ],
    },
    {
      title: "Certification Programs as Career Currency",
      tag: "CREDENTIALING", date: "Jan 2026", read: "7 min", color: "#22c55e",
      body: [
        { type: "p", text: "Certifications live in an uncomfortable space. They're either the most meaningless credential (checkbox for tier status) or the most valuable career asset (proof of mastery). The difference is how you design them. I've built certification programs that landed in the second category." },
        { type: "h2", text: "Tiered Credentials Drive Engagement" },
        { type: "p", text: "A binary certification (you have it or you don't) creates no growth incentive beyond the initial achievement. Instead, design tiers: foundational (demonstrates basic competency), practitioner (hands-on application), expert (architectural decisions). Each tier has clear entry criteria, practical assessments, and business value. Engineers pursue the next tier because it opens new project types, not because management said so." },
        { type: "h2", text: "Align with Platform Expectations" },
        { type: "p", text: "Each technology vendor (Sitecore, Optimizely, Shopify, etc.) has different certification structures and update cycles. I built a unified framework that accommodates all of them without creating five separate bureaucracies. The structure is consistent, the content adapts to each platform's requirements." },
        { type: "h2", text: "Renewal Cycles Are Infrastructure, Not Projects" },
        { type: "p", text: "The moment a certification ships is day one of the renewal cycle. If you don't track expirations, plan renewal windows, and build time for recertification into your team's capacity, your credentials will silently become outdated. I operationalized this with automated reminders, manager dashboards, and a rolling calendar that prevents last-minute cramming." },
        { type: "quote", text: "Credentials only mean something if they stay current. That's not a one-time project, it's ongoing infrastructure." },
      ],
    },
    {
      title: "L&D Integration in Acquired Companies: The First 90 Days",
      tag: "M&A INTEGRATION", date: "Dec 2025", read: "10 min", color: "#f97316",
      body: [
        { type: "p", text: "When your company acquires another organization, the learning and development infrastructure isn't an afterthought — it's the backbone of integration. I've led multiple L&D integration efforts, and the pattern that works is deliberate, structured, and focused on early wins." },
        { type: "h2", text: "Day One: Discovery, Not Onboarding" },
        { type: "p", text: "The acquired team is full of competent people who know how to do their jobs. They just don't know how you do yours. The first priority isn't to teach them everything — it's to understand where they are so you can align them efficiently. We run structured discovery: map roles to your competency framework, identify the biggest gaps, interview managers about the team's learning culture." },
        { type: "h2", text: "Days 1-30: Foundations and Belonging" },
        { type: "p", text: "In the first month, focus on three things: shared tools and processes, company culture and values, and creating early wins where the acquired team contributes visibly. Don't try to teach them your entire engineering standard in week one. Give them enough to be productive, then let them learn by doing." },
        { type: "h3", text: "Make the Tools Visible, Not the Jargon" },
        { type: "p", text: "The acquired team is going to encounter Jira, Confluence, Slack, and a dozen other tools they may not have used before. Don't assume they'll figure it out. Provide structured onboarding to the tools, not lectures about your process philosophy. Let them experience the benefits, then explain the thinking behind it." },
        { type: "h2", text: "Days 30-60: Capability Alignment" },
        { type: "p", text: "Now you focus on skill gaps. Enroll the team in relevant certification tracks, pair them with internal mentors for hands-on learning, and start assigning them to projects where they can apply new skills immediately. This is where you build credibility — they see that the learning path actually prepares them for the work." },
        { type: "h2", text: "Days 60-90: Independence and Ownership" },
        { type: "p", text: "By day 90, the acquired team should be operating with minimal L&D support. They understand the standards, they're pursuing their own professional development, and they're contributing at expected quality levels. Your job at this point is to maintain the infrastructure, not to manually support each person." },
        { type: "quote", text: "The integration is complete when you can no longer tell who was the legacy organization and who was acquired. That's when the infrastructure you built actually worked." },
      ],
    },
  ];
      ...
      <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center" }}>
        ...
        <Reveal delay={0.2}>
          <p style={{ fontFamily: "var(--font-body)", fontSize: 18, lineHeight: 1.7, color: "var(--text-secondary)", maxWidth: 500, margin: "0 auto 48px" }}>
            Exploring roles in Enterprise L&D, AI Adoption, and Knowledge Management at forward-thinking organizations.
          </p>
        </Reveal>
        <Reveal delay={0.3}>
          <div style={{ display: "flex", justifyContent: "center", gap: 16, flexWrap: "wrap" }}>
            {[
              ...
              { icon: <Github size={18} />, label: "GitHub", href: "https://github.com/ingenieriawebudla", color: "var(--text-primary)" },
            ].map((link, i) => (
              <a
                key={i}
                href={link.href}
